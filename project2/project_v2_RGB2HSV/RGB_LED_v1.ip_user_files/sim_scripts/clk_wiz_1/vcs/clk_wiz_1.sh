...
#
# Generated by Vivado on Sun Jul 26 19:24:45 +0800 2020
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../RGB_LED_v1.srcs/sources_1/ip/clk_wiz_1/clk_wiz_1_clk_wiz.v" \
    "$ref_dir/../../../../RGB_LED_v1.srcs/sources_1/ip/clk_wiz_1/clk_wiz_1.v" \
  2>&1 | tee -a vlogan.log
